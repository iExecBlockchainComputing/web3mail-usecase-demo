/**
 * Update cy.visit() to include the Eip6963Provider
 */
...
export const METAMASK_MOCK_NAME = 'MetaMask Mock';

export const addEip6963ProviderToWindow = (
  win: Cypress.AUTWindow,
  options?: Partial<Cypress.VisitOptions>
) => {
  if (options?.selectedWallet === METAMASK_MOCK_NAME) {
    ...
    const metamaskMock = new MetaMaskMock(wallet, PROVIDERS_MAP[chain]);
    win.addEventListener(EIP6963_REQUEST_EVENT, (e) => {
      win.dispatchEvent(
        new CustomEvent(EIP6963_ANNOUNCE_EVENT, {
          detail: Object.freeze({
            info: {
              uuid: '5889de0c-c4a0-4699-ad74-64533b22c2e4',
              name: METAMASK_MOCK_NAME,
              rdns: 'io.metamask',
